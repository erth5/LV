    ...
    <table>
        ...
        @foreach($data as $column)
            <tr>
                ...
                <td>
                    <label>
                        <input name="editor{{$column->id}}" type="text" maxlength="255" autocomplete="on" placeholder="{{$column->editor}}">
                    </label>
                </td>
                <td>
                    <label>
                        <input name="word1{{$column->id}}" type="text" maxlength="255" autocomplete="on" placeholder="{{$column->word1}}">
                    </label>
                </td>
                <td>
                    <label>
                        <input name="word2{{$column->id}}" type="text" maxlength="255" autocomplete="on" placeholder="{{$column->word2}}">
                    </label>
                </td>
                <td>
                    <label>
                        <input name="word3{{$column->id}}" type="text" maxlength="255" autocomplete="on" placeholder="{{$column->word3}}">
                    </label>
                </td>
                <td class="sub_unique">
